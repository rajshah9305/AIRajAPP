                ...
                <div className="sm:hidden flex items-center gap-1 bg-white rounded-lg p-1 border border-gray-200">
                  <button
                    ...
                    className={`p-1.5 rounded text-xs font-medium transition-colors ${
                      currentView === 'preview' ? 'bg-orange-100 text-orange-700' : 'text-gray-600 hover:bg-gray-100'
                    }`}
                  >
                  ...
                  <button
                    ...
                    className={`p-1.5 rounded text-xs font-medium transition-colors ${
                      currentView === 'code' ? 'bg-orange-100 text-orange-700' : 'text-gray-600 hover:bg-gray-100'
                    }`}
                  >
                  ...
                  {(['preview', 'code', 'both'] as const).map((v) => (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-lg text-xs font-medium transition-colors ${
                        currentView === v ? 'bg-orange-100 text-orange-700' : 'bg-white text-gray-600 hover:bg-gray-100'
                      }`}
                    >
                      {v === 'preview' && <Eye className="w-3 h-3 inline mr-1" />}
                      {v === 'code' && <Code2 className="w-3 h-3 inline mr-1" />}
                      {v === 'both' && null}
