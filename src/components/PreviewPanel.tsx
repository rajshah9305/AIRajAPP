...
return {
‘/App.tsx’: {
code: `export default function App() { return ( <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh', width: '100vw', fontFamily: 'system-ui, -apple-system, sans-serif', color: '#64748b', background: 'linear-gradient(135deg, #fef3c7 0%, #fecaca 100%)', margin: 0, padding: 0 }}> <div style={{ textAlign: 'center', padding: '2rem' }}> <div style={{ fontSize: '64px', marginBottom: '16px', opacity: 0.6 }}>⚡</div> <div style={{ fontSize: '18px', fontWeight: 600, marginBottom: '8px', color: '#334155' }}> Waiting for AI Magic </div> <div style={{ fontSize: '14px', color: '#64748b' }}> Generate a component to see live preview </div> </div> </div> ); }`,
}
};
}
          ...
          <Sandpack
            ...
            options={{
              ...
              classes: {
                ...
                'sp-layout': 'sandpack-layout-full',
                'sp-preview': 'sandpack-preview-full',
              },
            }}
            customSetup={{
              dependencies: {
